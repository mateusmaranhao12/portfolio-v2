...
export default function ExperienciaItem({ cargo, empresa, periodo, descricao }: ExperienciaItemProps) {
    return (
        <div className="bg-purple-800/10 border border-purple-700 rounded-xl p-6 backdrop-blur-sm hover:shadow-[0_0_15px_#ffffff22] transition">
            <h3 className="text-xl font-bold text-yellow-300">{cargo}</h3>
