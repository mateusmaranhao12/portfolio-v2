export const pt = {
  ...
  experiencia_empresa_1: "Prefeitura de Aracaju - COGETIN",
  ...
  certificado_dw_completo_desc:
    "Meu primeiro curso de desenvolvimento Full-Stack realizado em 2021, para aprender e me aprofundar em tecnologias como HTML5, CSS3, JavaScript, MySQL, PHP, Bootstrap, etc.",
  certificado_vue_desc:
    "Curso realizado em 2022, com o objetivo de aprender e aprofundar no VueJS e suas tecnologias como Vuex, vue-router, componentização e animações.",
  certificado_wise_up_desc:
    "Curso realizado em 2023 para desenvolver meu inglês.",
  certificado_react_nextjs_desc:
    "Curso realizado para aprimorar meus conhecimentos em React e NextJS.",
  certificado_git_github_desc:
    "Curso realizado para aprofundar conhecimentos já aplicados em projetos anteriores.",
