...
export default function Sobre() {
    ...
    const paragrafos = [
        `Olá! Sou <strong class="text-yellow-300">Mateus Nunes Maranhão</strong>, 
            graduado em <strong class="text-yellow-300">Ciência da Computação</strong> pela <strong class="text-yellow-300">Universidade Tiradentes</strong> em Aracaju - SE. Movido por desafios e apaixonado por desenvolvimento web, atuo com tecnologias como React.js, Next.js, Vue.js, Node.js, TypeScript e PHP.`,
